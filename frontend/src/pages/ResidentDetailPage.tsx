    ...
    <div>
      ...
      <div className="container-fluid py-4">
        ...
        {activeTab === 'recordings' && (
          <div className="card">
            <div className="card-header">
              Process Recordings ({recordings.length})
            </div>
            <div className="card-body">
              {recordings.length === 0 ? (
                ...
                <div className="list-group list-group-flush">
                  {recordings.map((r) => (
                    <div key={r.recordingId} className="list-group-item px-0">
                      ...
                      {r.sessionNarrative && (
                        <p className="mb-1 small mt-1">{r.sessionNarrative}</p>
                      )}
                      <div className="d-flex gap-2 mt-1">
                        {r.progressNoted && (
                          <span className="badge bg-success">Progress</span>
                        )}
                        {r.concernsFlagged && (
        ...
        {activeTab === 'visitations' && (
          <div className="card">
            <div className="card-header">
              Home Visitations ({visitations.length})
            </div>
            <div className="card-body">
