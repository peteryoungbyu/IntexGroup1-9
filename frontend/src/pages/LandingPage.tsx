  ...
  const pillars = [
    {
      ...
      bg: '#dbeafe',
      icon: (
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#1a5276" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      bg: '#dcfce7',
      icon: (
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#166534" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 22V12"/>
    ...
    },
    {
      ...
      bg: '#fef9c3',
      icon: (
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#854d0e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <section className="hero-section">
          ...
          <div className="hero-content">
            ...
            <h1 className="display-5 fw-bold text-white mb-3" style={{ lineHeight: 1.15 }}>
              Restoring Hope for<br />Girls in the Philippines
            </h1>
            <p className="text-white mb-4" style={{ opacity: 0.85, fontSize: '1.05rem', lineHeight: 1.6 }}>
              We provide safe shelter, healing, and education to girls who need it most — giving them the foundation for a brighter future.
            </p>
        ...
        <section className="py-5 bg-white">
          <div className="container">
            <div className="text-center mb-5">
              ...
              <h2 className="fw-bold" style={{ fontSize: '2rem', color: 'var(--brand-dark)' }}>Our Approach</h2>
            </div>
              ...
              {pillars.map(p => (
                  <div key={p.title} className="col-md-4">
                    <div className="pillar-card h-100">
                      ...
                      <h4 className="fw-bold mb-2" style={{ color: 'var(--brand-dark)' }}>{p.title}</h4>
            ...
            <section className="py-5" style={{ background: 'var(--brand-light)' }}>
              <div className="container">
                <div className="text-center mb-5">
                  ...
                  <h2 className="fw-bold" style={{ fontSize: '2rem', color: 'var(--brand-dark)' }}>Recent Impact</h2>
                </div>
                <div className="row g-4">
                  {snapshots.map(s => (
                ...
                <div className="text-center mt-5">
                  <Link to="/impact" className="btn btn-primary btn-lg px-5 fw-bold">
