...
const tiers = [
  ...
  },
  {
    amount: 5000,
    label: '₱5,000',
    impact: 'Supports one girl\'s full month of care — shelter, meals, and therapy',
    icon: '🏠',
  },
];

const allocation = [
  { label: 'Safe Shelter & Daily Care', percent: 40, color: 'var(--brand-primary)' },
      ...
      <div className="py-5" style={{ minHeight: '60vh', display: 'flex', alignItems: 'center' }}>
        <div className="container text-center">
          <div
            ...
            aria-hidden="true"
          >
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#166534" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p className="text-muted mb-2" style={{ fontSize: '1.05rem', maxWidth: 520, margin: '0 auto 1rem' }}>
            Your pledge of <strong>₱{(effectiveAmount ?? 0).toLocaleString()}</strong>
            {recurring ? ' per month' : ''} means the world to the girls of New Dawn Foundation.
          </p>
          <p className="text-muted mb-4" style={{ maxWidth: 480, margin: '0 auto 1.5rem' }}>
          ...
          <div className="d-flex gap-3 justify-content-center flex-wrap">
            <Link to="/register" className="btn btn-primary btn-lg fw-bold px-5">
              Create Your Account
            </Link>
      ...
      <section className="hero-section" style={{ minHeight: 340 }}>
        ...
        <div className="hero-content">
          ...
          <h1 className="display-5 fw-bold text-white mb-3" style={{ lineHeight: 1.15 }}>
            Your Gift<br />Changes Lives
          </h1>
          <p className="text-white" style={{ opacity: 0.85, fontSize: '1.05rem', lineHeight: 1.6 }}>
            100% of your donation goes directly toward shelter, healing, and education for girls who need it most.
          </p>
        </div>
      </section>
          ...
          <div className="row g-5 align-items-start">
            ...
            <div className="col-lg-7">
              <div className="card card-hover p-4 p-md-5">
                <h2 className="fw-bold mb-1" style={{ color: 'var(--brand-dark)' }}>Choose Your Impact</h2>
                <p className="text-muted mb-4">Select an amount or enter your own.</p>

                {/* Tier buttons */}
                <div className="row g-3 mb-4" role="group" aria-label="Donation amount options">
                  {tiers.map((t) => (
                    <div key={t.amount} className="col-6">
                      <button
                        ...
                        style={{
                          ...
                          background: selected === t.amount && !custom ? '#eff6ff' : '#fff',
                          cursor: 'pointer',
                      ...
                      >
                        <div className="d-flex align-items-center gap-2 mb-1">
                          ...
                          <span className="fw-bold" style={{ color: 'var(--brand-dark)', fontSize: '1.1rem' }}>
                            {t.label}
                          </span>
                        </div>
                ...
                {/* Custom amount */}
                <div className="mb-4">
                  <label htmlFor="custom-amount" className="form-label fw-semibold" style={{ color: 'var(--brand-dark)' }}>
                ...
                <div className="mb-4">
                  <div className="form-check form-switch">
                    ...
                    />
                    <label className="form-check-label fw-semibold" htmlFor="recurring-toggle">
                      Make this a monthly gift
                    </label>
                  </div>
                  <p className="text-muted small mt-1 mb-0">
                    Monthly donors provide reliable, year-round support that helps us plan programs with confidence.
                  </p>
                </div>
            ...
            <div className="col-lg-5">
              ...
              <div className="card p-4 mb-4">
                <h5 className="fw-bold mb-3" style={{ color: 'var(--brand-dark)' }}>How Your Donation Is Used</h5>
                {allocation.map((a) => (
                  <div key={a.label} className="mb-3">
                    <div className="d-flex justify-content-between mb-1">
                      <span className="small fw-semibold" style={{ color: 'var(--brand-dark)' }}>{a.label}</span>
                      <span className="small fw-bold" style={{ color: a.color }}>{a.percent}%</span>
                    </div>
                    <div className="progress" style={{ height: 8, borderRadius: 8 }} role="progressbar" aria-valuenow={a.percent} aria-valuemin={0} aria-valuemax={100} aria-label={`${a.label}: ${a.percent}%`}>
                      <div
                        className="progress-bar"
                        style={{ width: `${a.percent}%`, background: a.color, borderRadius: 8 }}
                      />
                    </div>
                  </div>
                ))}
              ...
              {/* Trust signals */}
              <div className="card p-4 mb-4">
                <h5 className="fw-bold mb-3" style={{ color: 'var(--brand-dark)' }}>Why Give to New Dawn?</h5>
                <ul className="list-unstyled mb-0">
                  {[
                    ...
                    <li key={item} className="d-flex align-items-start gap-2 mb-2">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--brand-primary)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 mt-1" aria-hidden="true">
                        <polyline points="20 6 9 17 4 12" />
                      </svg>
