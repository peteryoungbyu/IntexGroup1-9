        ...
        <div className="container" style={{ maxWidth: 800 }}>
          <div className="card">
            <div className="card-body p-4 p-md-5">
              ...
              <p className="mb-4">This page explains what cookies and browser storage this application uses and why.</p>
              ...
              <h2 className="h5 fw-bold" style={{ color: 'var(--brand-dark)' }}>How to manage cookies</h2>
              ...
              <p className="mb-0">We do not use advertising, tracking, or analytics cookies.</p>
            </div>
          </div>
        </div>
      </div>
