...
const values = [
  {
    ...
    bg: '#dbeafe',
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#1a5276" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    bg: '#dcfce7',
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#166534" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    bg: '#fef9c3',
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#854d0e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    bg: '#fce7f3',
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#9d174d" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export default function AboutPage() {
  ...
  const stats = summary
    ? [
        { value: summary.totalGirlsServed.toLocaleString(), label: 'Girls Served' },
        { value: summary.numberOfSafehouses.toString(), label: 'Safehouses' },
        { value: summary.yearsOperating.toString(), label: 'Years Operating' },
        { value: summary.staffAndVolunteers.toLocaleString(), label: 'Staff & Volunteers' },
      ]
    : [
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          ...
          <h1 className="display-5 fw-bold text-white mb-3" style={{ lineHeight: 1.15 }}>
            Restoring Hope,<br />One Life at a Time
          </h1>
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              ...
              <h2 className="fw-bold mb-4" style={{ color: 'var(--brand-dark)', fontSize: '2rem' }}>
                A Problem Too Big to Ignore
              </h2>
              <p className="text-muted mb-3" style={{ lineHeight: 1.8 }}>
                In the Philippines, thousands of girls face trafficking, abuse, and neglect every year. Many cycle through
                temporary shelters with no consistent support — and no path forward. In January 2022, a group of social
                workers, educators, and community leaders in Quezon City decided that wasn't good enough.
              </p>
              <p className="text-muted mb-3" style={{ lineHeight: 1.8 }}>
                New Dawn Foundation opened its first safehouse — Lighthouse Safehouse 1 — in Quezon City on January 1, 2022.
                The mission was clear: don't just keep girls safe tonight — give them everything they need to thrive for a lifetime.
              </p>
              <p className="text-muted mb-0" style={{ lineHeight: 1.8 }}>
                Since 2022, we have grown to operate multiple safehouses across the region, building a community of supporters,
                social workers, and partners all united around one goal: restoring hope for girls who need it most.
              </p>
            </div>
            <div className="col-lg-6">
              <div
          ...
          <div className="row g-4 text-center">
            {stats.map((s) => (
              <div key={s.label} className="col-6 col-md-3">
                ...
                <div className="text-white" style={{ opacity: 0.85, fontWeight: 500 }}>
                  {s.label}
                </div>
              </div>
            ))}
            ...
            <div className="col-md-6">
              <div className="card card-hover h-100 p-4">
                <div
                  ...
                  aria-hidden="true"
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1a5276" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <circle cx="12" cy="12" r="10" />
                    <line x1="12" y1="8" x2="12" y2="12" />
                    <line x1="12" y1="16" x2="12.01" y2="16" />
                  </svg>
                </div>
                <h3 className="fw-bold mb-3" style={{ color: 'var(--brand-dark)' }}>Our Mission</h3>
                <p className="text-muted mb-0" style={{ lineHeight: 1.8 }}>
                  To provide comprehensive, trauma-informed care to girls who have experienced abuse, trafficking, or neglect —
                  giving them the safety, healing, and education they need to build independent and fulfilling lives.
                </p>
              </div>
            </div>
            <div className="col-md-6">
              <div className="card card-hover h-100 p-4">
                ...
                <h3 className="fw-bold mb-3" style={{ color: 'var(--brand-dark)' }}>Our Vision</h3>
                <p className="text-muted mb-0" style={{ lineHeight: 1.8 }}>
                  A Philippines where every girl is free from exploitation, has access to quality care and education,
                  and is empowered to reach her full potential — contributing to her family, community, and nation.
                </p>
              </div>
            </div>
          </div>
