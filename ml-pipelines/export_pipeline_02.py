"""Export reintegration readiness model (pkl) to ONNX."""
import pickle
import numpy as np
...
with open("models/reintegration_model.pkl", "rb") as f:
...
# Swap categorical imputer to use string missing_values (required by skl2onnx)
...
with open("models/reintegration_model.onnx", "wb") as f:
    f.write(onnx_model.SerializeToString())

print("Exported to models/reintegration_model.onnx")

import onnxruntime as ort
sess = ort.InferenceSession("models/reintegration_model.onnx")
