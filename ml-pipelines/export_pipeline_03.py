"""Export donor upsell model (pkl) to ONNX."""
import pickle
import numpy as np
...
with open("models/donor_upsell_model.pkl", "rb") as f:
    bundle = pickle.load(f)

model = bundle["model"]
features = bundle["features"]
threshold = bundle.get("threshold", 0.3)
...
with open("models/donor_upsell_model.onnx", "wb") as f:
    f.write(onnx_model.SerializeToString())

print("Exported to models/donor_upsell_model.onnx")

import onnxruntime as ort
sess = ort.InferenceSession("models/donor_upsell_model.onnx")
