"""Export social media donations models (pkl) to ONNX — both classification and regression."""
import pickle
import numpy as np
...
export_model(
    "models/social_media_donations_classification_model.pkl",
    "models/social_media_donations_classification_model.onnx",
    is_classifier=True,
)

export_model(
    "models/social_media_donations_regression_model.pkl",
    "models/social_media_donations_regression_model.onnx",
    is_classifier=False,
)
